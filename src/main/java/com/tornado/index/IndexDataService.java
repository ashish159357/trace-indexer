...
public class IndexDataService {
        ...
        try {
            ...
            for (Map.Entry<String, Object> entry : fields.entrySet()) {
                ...
                if (TraceFieldExtractor.getSpanFields().containsKey(fieldName)) {
                    ...
                    prepareDocSpanFields(doc, fieldName, value);

                }else if(TraceFieldExtractor.getResourceFields().containsKey(fieldName)) {

                    prepareDocResourceFields(doc, fieldName, value);
    ...
    public static void prepareDocResourceFields(Document doc, String fieldName, Object value){
        try{
            ...
            log.error("unable to prepare indexing document for Resource Fields : {}", e.getMessage());
        }

    }

    public static void prepareDocSpanFields(Document doc, String fieldName, Object value){
        try{
            if (value instanceof String v) {
                // Determine a field type based on name convention or explicit type info
                if (fieldName.endsWith("Id")) {
            ...
            log.error("unable to prepare indexing document for Span Fields : {}", e.getMessage());
        }
    }
}
